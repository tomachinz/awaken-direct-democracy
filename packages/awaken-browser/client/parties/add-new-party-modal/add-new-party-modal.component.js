angular.module('awaken.browser').directive('addNewPartyModal', function () {
  return {
    restrict: 'E',
    templateUrl: '/packages/awaken-browser/client/parties/add-new-party-modal/add-new-party-modal.html',
